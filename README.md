...
In this [Okta Training](https://www.okta.com/training/) hands-on lab, learners will put their API knowledge into practice by creating an API in their Auth0 tenant, deploying a test API into the lab environment, obtaining a test Access Token, and calling the test API using the token.
